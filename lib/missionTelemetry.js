...
(function () {
	 ...
	 *
	 * `outcome` is 'cleared' or 'failed'. Both must reach the CSV: a win-only
	 * dataset makes every build look as durable as its luckiest runs, which
	 * flatters glass-cannon builds exactly where they are weakest.
	 */
